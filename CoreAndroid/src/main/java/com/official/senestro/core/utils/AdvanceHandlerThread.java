...
import com.official.senestro.core.callbacks.interfaces.AdvanceHandlerThreadToUICallback;
...
public class AdvanceHandlerThread {
     ...
     */
    public static void runInBackground(AdvanceHandlerThreadCallback callback) {
        if (callback != null) {
     ...
     */
    public static void runInBackgroundToUi(AdvanceHandlerThreadToUICallback callback, int killThreadIn) {
        if (callback != null) {
