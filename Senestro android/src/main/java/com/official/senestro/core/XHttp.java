...
import com.official.senestro.core.callbacks.interfaces.XHttpCallback;
...
public class XHttp {
    ...
    private static void trustManager() throws NoSuchAlgorithmException, GeneralSecurityException, IOException {
        ...
        sc.init(null, new TrustManager[]{XUtils.unsafeTrustManager(null)}, new SecureRandom());
