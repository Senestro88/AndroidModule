...
public class XFile  extends File {
    ...
    public String getMimeFromFileExtension() {
        ...
        return !extension.isEmpty() ? XUtils.getMimeFromExtension(extension) : "";
    }
    ...
    public String getExtension() {
        try {
            return isFile() ? XUtils.getExtension(getAbsolutePath()).toLowerCase() : "";
        } catch (Throwable e) {
            return "";
        }
    }
     ...
     */
    public long getSize() {
        return XUtils.getFileSize(getAbsolutePath());
    }
    ...
    public List<XFile> listXFiles(boolean recursively) {
        return isDirectory() && canRead() ? XUtils.listDir(this, recursively) : new ArrayList<>();
    }
