...
import com.official.senestro.core.callbacks.interfaces.XWifiEventsCallback;
import com.official.senestro.core.callbacks.interfaces.XWifiLocalHotspotCallback;
...
public class XWifi {
    private static final String tag = XWifi.class.getName();

    private final @NonNull Context context;
    private final @NonNull CallBackHandler handler;
    private XWifiEventsCallback callback;
    ...
    public static XWifi getInstance(@NonNull Context context) {
        if (instance == null) {
            synchronized (XWifi.class) {
                if (instance == null) {
                    instance = new XWifi(context);
                }
            }
        }
        return instance;
     ...
     */
    public void registerEvents(@NonNull XWifiEventsCallback callback) {
    ...
    public void startLocalOnlyHotspot(@NonNull XWifiLocalHotspotCallback callback) {
        closeWifi();
    ...
    private static class CallBackHandler {
        private final @NonNull XWifi instance;

        public CallBackHandler(@NonNull XWifi instance) {
