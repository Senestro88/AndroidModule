...
public class AdvanceFloatingVideo {
    ...
    public AdvanceFloatingVideo(@NonNull Context context) {
    ...
    private void setVariables() {
        ...
        view = inflater.inflate(R.layout.advance_floating_video, null, true);
    ...
    private void pausePlayback() {
        if (isFloating && isVideoPrepared && isVideoPlaying) {
            video.pause();
            ic_play.setImageResource(R.mipmap.ic_play_white);
            isVideoPlaying = false;
        }
    }
