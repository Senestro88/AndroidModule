...
public class AdvanceFloatingDialog {
    ...
    public AdvanceFloatingDialog(@NonNull Context context) {
    ...
    private void init() {
        ...
        view = inflater.inflate(R.layout.advance_floating_dialog, null, true);
