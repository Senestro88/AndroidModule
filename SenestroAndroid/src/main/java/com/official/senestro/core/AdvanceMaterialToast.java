...
public class AdvanceMaterialToast {
    ...
    public AdvanceMaterialToast(Context context) {
    ...
    public Toast warningToast(@StringRes int message, int length, boolean withIcon) {
        return createCustom(context.getString(message), getDrawable(R.mipmap.ic_material_toast_error_outline_white), getColor(R.color.materialToastWarningColor), getColor(R.color.materialToastDefaultTextColor), length, withIcon, true);
    }

    @CheckResult
    public Toast warningToast(@NonNull CharSequence message, int length, boolean withIcon) {
        return createCustom(message, getDrawable(R.mipmap.ic_material_toast_error_outline_white), getColor(R.color.materialToastWarningColor), getColor(R.color.materialToastDefaultTextColor), length, withIcon, true);
    }
    ...
    public Toast infoToast(@StringRes int message, int length, boolean withIcon) {
        return createCustom(context.getString(message), getDrawable(R.mipmap.ic_material_toast_info_outline_white), getColor(R.color.materialToastInfoColor), getColor(R.color.materialToastDefaultTextColor), length, withIcon, true);
    }

    @CheckResult
    public Toast infoToast(@NonNull CharSequence message, int length, boolean withIcon) {
        return createCustom(message, getDrawable(R.mipmap.ic_material_toast_info_outline_white), getColor(R.color.materialToastInfoColor), getColor(R.color.materialToastDefaultTextColor), length, withIcon, true);
    }
    ...
    public Toast successToast(@StringRes int message, int length, boolean withIcon) {
        return createCustom(context.getString(message), getDrawable(R.mipmap.ic_material_toast_check_white), getColor(R.color.materialToastSuccessColor), getColor(R.color.materialToastDefaultTextColor), length, withIcon, true);
    }

    @CheckResult
    public Toast successToast(@NonNull CharSequence message, int length, boolean withIcon) {
        return createCustom(message, getDrawable(R.mipmap.ic_material_toast_check_white), getColor(R.color.materialToastSuccessColor), getColor(R.color.materialToastDefaultTextColor), length, withIcon, true);
    }
    ...
    public Toast errorToast(@StringRes int message, int length, boolean withIcon) {
        return createCustom(context.getString(message), getDrawable(R.mipmap.ic_material_toast_clear_white), getColor(R.color.materialToastErrorColor), getColor(R.color.materialToastDefaultTextColor), length, withIcon, true);
    }

    @CheckResult
    public Toast errorToast(@NonNull CharSequence message, int length, boolean withIcon) {
        return createCustom(message, getDrawable(R.mipmap.ic_material_toast_clear_white), getColor(R.color.materialToastErrorColor), getColor(R.color.materialToastDefaultTextColor), length, withIcon, true);
    }
    ...
    public Toast createCustom(@NonNull CharSequence message, Drawable icon, @ColorInt int tintColor, @ColorInt int textColor, int length, boolean withIcon, boolean shouldTint) {
        Toast toast = Toast.makeText(context, "", length);
        LayoutInflater inflater = LayoutInflater.from(context);
        View view = inflater.inflate(R.layout.advance_material_toast, null);
        ConstraintLayout toastRoot = view.findViewById(R.id.material_toast_root);
        ImageView toastIcon = view.findViewById(R.id.material_toast_icon);
        TextView toastText = view.findViewById(R.id.material_toast_text);
        setToastBackground(view, shouldTint, tintColor);
        setToastIcon(toastRoot, toastIcon, icon, textColor, withIcon);
        toastText.setText(message);
        toastText.setTextColor(textColor);
        toastText.setTypeface(matTypeface);
        toastText.setTextSize(2, (float) matTextSize);
        toast.setView(view);
        setToastQueue(toast);
        int gravity = matToastGravity == -1 ? toast.getGravity() : matToastGravity;
        int xOffset = matXOffset == -1 ? toast.getXOffset() : matXOffset;
        int yOffset = matYOffset == -1 ? toast.getYOffset() : matYOffset;
