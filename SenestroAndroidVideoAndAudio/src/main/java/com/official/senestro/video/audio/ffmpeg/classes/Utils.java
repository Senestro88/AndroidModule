...
public class Utils {
    ...
    public static boolean canRead(@Nullable File path) {
        return notNull(path) && path.canRead();
    }

    public static boolean canExecute(@Nullable File path) {
        return notNull(path) && path.canExecute();
    }

    public static boolean canWrite(@Nullable File path) {
        return notNull(path) && path.canWrite();
    }
