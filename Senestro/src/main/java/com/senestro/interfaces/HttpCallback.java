 ...
 * the {@link com.senestro.Http} class.</p>
 *
 * @author Senestro
 */
public interface HttpCallback {
     ...
     *
     * @param success Indicates if the response status code is considered
     *                successful.
     ...
     */
    void onResponse(boolean success, int code, @NonNull String message, @NonNull Map<String, String> headers, @NonNull String body);
